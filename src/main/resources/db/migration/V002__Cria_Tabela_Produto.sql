...
INSERT INTO `produto` (`id`,`nome`,`preco`,`categoria_id`) VALUES (2,'Mesa Computador',357.80,2);
INSERT INTO `produto` (`id`,`nome`,`preco`,`categoria_id`) VALUES (3,'Desodorante',5.20,3);
